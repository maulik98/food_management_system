...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="text-align: center">Create User</div><br>
                    <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <select style="margin-left: 14px;" class="col-form-label col-md-3" name="user_type" id="user_type">
                                <option value="volunteer">Volunteer</option>
                                <option value="food_checker">Food Checker</option>
                            </select>
                        </div>
